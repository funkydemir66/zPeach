...
def start(s):
    ...
    global kod, user_id, so, yon, tcho, harekets, v1,harekets2, npcs, t_id, ft, d1 ,d2, scho, sahipnick, ss, v1 ,v2, u1, h1, dinle, dinle2, sp, to, harekets, tcho, iv, nmode, tmode, r_id1, r_id2, sw, spamword2, spamword, sn, partymod, spamkod,swo
